...
export default function Footer() {
  ...
  return (
    <div
      className={`mobileHeadingLayout md:desktopHeadingLayout md:min-h-40 min-h-60 bg-brand-100 md:p-4 flex flex-col justify-center items-center`}
    >
      ...
      <div className="flex flex-col justify-center items-center mt-6">
        ...
        <div className="flex flex-col gap-2 mt-6">
          ...
          <button
            ...
            className="text-xs px-1 py-0.5 flex justify-center items-center text-foreground border border-brand-400 rounded-sm cursor-pointer hover:bg-brand-200 duration-75 ease-in-out transition-colors"
          >
            Contact Me
          </button>
        </div>
